# module_2 EDA Начальный Анализ Данных
...
## Задача данного проекта
 ...
 - Научиться очистке данных загруженных на первом этапе
 - Научиться первичному анализу данных
 - Закрепить знания по работе с графическими библиотеками для построения графиков: matplotlib.pyplot, seaborn etc.
...
2. Что не получилось сделать так, как хотелось? Над чем ещё стоит поработать?
   - Нужно посмотреть больше материалов по статистике.

3. Что интересного и полезного вы узнали в этом модуле?
   - Статистика - почувствуй себя Анатолием Ефремовичем Новосельцевым!
